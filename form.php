...
<div class="container">
  <h2>inscription</h2>
  <p>Fill in the boxes as appropriate </p>
  <form action="affiche.php" method="POST" class="was-validated" >
    ...
    <div class="form-group form-check">
      <label class="form-check-label">
        <input class="form-check-input" type="checkbox" name="remember" required> registered successfully.
        <div class="valid-feedback">Valid.</div>
